...
nexpl=15;
nexpr=20; % 33 and 47 are deafult values; 29 and 39, estimated statistically, 95% ; 33, 47 %98 for voicebox pitch
sign_vad=0;
for i=1:nfr10
...
nexpl =2; nexpr=5; % deafult is 5 & 12, 9 and 13, estimated statistically 5%; 5, 12 %2 for voicebox pitch
sign_vad=0;
for i=1:nfr10
    if snre_vad(i)==1 && sign_vad==0
        nstart=i;
    ...
    elseif (snre_vad(i)==0 || i==nfr10) && sign_vad==1
        ...
        if esegment < 0.002 %default value is 0.001
